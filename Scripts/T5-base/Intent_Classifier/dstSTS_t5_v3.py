...
# SEMANTIC TEXT SIMILARITY PT
model_sts = SentenceTransformer('rufimelo/bert-large-portuguese-cased-sts')
...
# Load model
model2 = BertForSequenceClassification.from_pretrained(drive_folder)

# Explicitly load the tokenizer using the vocab.txt file (with UTF-8 encoding)
vocab_path = drive_folder + 'vocab.txt'
tokenizer2 = BertTokenizer(vocab_file=vocab_path, do_lower_case=False)
        ...
        if len(linha) == 2:
                                        ...
                                        if linha[0] == "\"attraction-type\"":
                                            for line in f:
                                                attraction_type.append(
                                                    get_slots_pt("attraction-type", "architecture"))
                                                ...
                                                attraction_type.append(
                                                    get_slots_pt("attraction-type", "concerthall"))
                                                attraction_type.append(
                                                    get_slots_pt("attraction-type", "entertainment"))
                                                ...
                                                attraction_type.append(
                                                    get_slots_pt("attraction-type", "swimmingpool"))
                                ...
                                if len(linha) == 2:
                                    if linha[1] == " [":
                                        ...
                                        if linha[0] == "\"hotel-pricerange\"":
                                            for line in f:
                                                hotel_pricerange.append(
                                                    get_slots_pt("hotel-pricerange", "expensive"))
                                                hotel_pricerange.append(get_slots_pt("hotel-pricerange", "cheap"))
                                                hotel_pricerange.append(
                                                    get_slots_pt("hotel-pricerange", "moderate"))
                                                hotel_pricerange.append(
                                                    get_slots_pt("hotel-pricerange", "dontcare"))
                                                break
                                        ...
                                        if linha[0] == "\"restaurant-bookday\"":
                                            for line in f:
                                                restaurant_bookday.append(
                                                    get_slots_pt("restaurant-bookday", "monday"))
                                                restaurant_bookday.append(
                                                    get_slots_pt("restaurant-bookday", "tuesday"))
                                                restaurant_bookday.append(
                                                    get_slots_pt("restaurant-bookday", "wednesday"))
                                                restaurant_bookday.append(
                                                    get_slots_pt("restaurant-bookday", "thursday"))
                                                restaurant_bookday.append(
                                                    get_slots_pt("restaurant-bookday", "friday"))
                                                restaurant_bookday.append(
                                                    get_slots_pt("restaurant-bookday", "saturday"))
                                                restaurant_bookday.append(
                                                    get_slots_pt("restaurant-bookday", "sunday"))
                                                restaurant_bookday.append(
                                        ...
                                        if linha[0] == "\"restaurant-name\"":
                                            for line in f:
                                                ...
                                                if restaurant_name == "dontcare":
                                                    restaurant_name = get_slots_pt("restaurant-name",
                                                                                   restaurant_name)
                                                break
            ...
            if turn_id == "turn_id" and int(number) % 2 == 0:
                for line in f:
                    ...
                    utterance = linha[3]
                    # Intent Classifier
                    encoded_new = tokenizer2(utterance, return_tensors="pt")
                    ...
                    with torch.no_grad():
                        outputs2 = model2(**encoded_new)
                        predicted_logits = outputs2.logits
                    ...
                    if present_intent == "attraction": # if 1 == 1:
                        for i in range(len(listaAttraction)):
                            ...
                            if i == 0 and score > 0.90:
                                attraction_area_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                     clean_up_tokenization_spaces=True)
                                for y in range(len(attraction_area)):
                                    embeddings1 = model_sts.encode(attraction_area[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(attraction_area_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                                    verify_attraction = 1
                            ...
                            if i == 1 and score > 0.95:
                                attraction_name_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                     clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(attraction_name, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(attraction_name_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_attraction = 1
                                    cont_attraction_certo = cont_attraction_certo + 1
                            ...
                            if i == 2 and score > 0.95:
                                attraction_type_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                     clean_up_tokenization_spaces=True)
                                for y in range(len(attraction_type)):
                                    embeddings1 = model_sts.encode(attraction_type[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(attraction_type_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                    ...
                    if present_intent == "hotel": # if 1 == 1:
                        for i in range(len(listaHotel)):
                            ...
                            if i == 0 and score > 0.95:
                                hotel_area_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_area)):
                                    embeddings1 = model_sts.encode(hotel_area[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_area_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 1 and score > 0.90:
                                hotel_bookday_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                   clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_bookday)):
                                    embeddings1 = model_sts.encode(hotel_bookday[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_bookday_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 2 and score > 0.80:
                                hotel_bookpeople_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                      clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_bookpeople)):
                                    embeddings1 = model_sts.encode(hotel_bookpeople[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_bookpeople_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 2:
                                if hotel_bookpeople != "" and hotel_bookpeople_2 == "" and ht_bookpeople == 1:
                                    verify_hotel = 0
                                    ht_bookpeople = 0
                                    cont_hotel_notfilled = cont_hotel_notfilled + 1
                            if i == 3 and score > 0.95:
                                hotel_bookstay_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                    clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_bookstay)):
                                    embeddings1 = model_sts.encode(hotel_bookstay[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_bookstay_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 4 and score > 0.95:
                                hotel_internet_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                    clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_internet)):
                                    embeddings1 = model_sts.encode(hotel_internet[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_internet_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 5 and score > 0.95:
                                hotel_name_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(hotel_name, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(hotel_name_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_hotel = 1
                                    cont_hotel_certo = cont_hotel_certo + 1
                            ...
                            if i == 6 and score > 0.95:
                                hotel_parking_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                   clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_parking)):
                                    embeddings1 = model_sts.encode(hotel_parking[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_parking_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 6:
                                if len(hotel_parking) != 0 and hotel_parking_2 == "" and ht_parking == 1:
                                    ...
                                    ht_parking = 0
                                    cont_hotel_notfilled = cont_hotel_notfilled + 1
                            if i == 7 and score > 0.80:
                                hotel_pricerange_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                      clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_pricerange)):
                                    embeddings1 = model_sts.encode(hotel_pricerange[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_pricerange_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 8 and score > 0.95:
                                hotel_stars_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                 clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_stars)):
                                    embeddings1 = model_sts.encode(hotel_stars[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_stars_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 8:
                                if hotel_stars != "" and hotel_stars_2 == "" and ht_stars == 1:
                                    verify_hotel = 0
                                    ht_stars = 0
                                    cont_hotel_notfilled = cont_hotel_notfilled + 1
                            if i == 9 and score > 0.95:
                                hotel_type_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                clean_up_tokenization_spaces=True)
                                for y in range(len(hotel_type)):
                                    embeddings1 = model_sts.encode(hotel_type[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(hotel_type_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                    ...
                    if present_intent == "restaurant": # if 1 == 1:
                        for i in range(len(listaRestaurant)):
                            ...
                            correct = 0
                            if i == 0 and score > 0.95:
                                restaurant_area_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                     clean_up_tokenization_spaces=True)
                                for y in range(len(restaurant_area)):
                                    embeddings1 = model_sts.encode(restaurant_area[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(restaurant_area_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 1 and score > 0.85:
                                restaurant_bookday_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                        clean_up_tokenization_spaces=True)
                                for y in range(len(restaurant_bookday)):
                                    embeddings1 = model_sts.encode(restaurant_bookday[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(restaurant_bookday_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 1:
                                if len(restaurant_bookday) != 0 and restaurant_bookday_2 == "" and rt_bookday == 1:
                                    ...
                                    cont_restaurant_notfilled = cont_restaurant_notfilled + 1
                            if i == 2 and score > 0.95:
                                restaurant_bookpeople_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                           clean_up_tokenization_spaces=True)
                                for y in range(len(restaurant_bookpeople)):
                                    embeddings1 = model_sts.encode(restaurant_bookpeople[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(restaurant_bookpeople_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 2:
                                if restaurant_bookpeople != "" and restaurant_bookpeople_2 == "" and rt_bookpeople == 1:
                                    verify_restaurant = 0
                                    rt_bookpeople = 0
                                    cont_restaurant_notfilled = cont_restaurant_notfilled + 1
                            if i == 3 and score > 0.90:
                                restaurant_booktime_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                         clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(restaurant_booktime, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(restaurant_booktime_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_restaurant = 1
                                    cont_restaurant_certo = cont_restaurant_certo + 1
                            ...
                            if i == 3:
                                if restaurant_booktime != "" and restaurant_booktime_2 == "" and rt_booktime == 1:
                                    ...
                                    cont_restaurant_notfilled = cont_restaurant_notfilled + 1
                            if i == 4 and score > 0.95:
                                restaurant_food_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                     clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(restaurant_food, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(restaurant_food_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_restaurant = 1
                                    cont_restaurant_certo = cont_restaurant_certo + 1
                            ...
                            if i == 4:
                                if restaurant_food != "" and restaurant_food_2 == "" and rt_food == 1:
                                    ...
                                    cont_restaurant_notfilled = cont_restaurant_notfilled + 1
                            if i == 5 and score > 0.95:
                                restaurant_name_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                     clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(restaurant_name, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(restaurant_name_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_restaurant = 1
                                    cont_restaurant_certo = cont_restaurant_certo + 1
                            ...
                            if i == 5:
                                if restaurant_name != "" and restaurant_name_2 == "" and rt_name == 1:
                                    ...
                                    rt_name = 0
                                    cont_restaurant_notfilled = cont_restaurant_notfilled + 1
                            if i == 6 and score > 0.90:
                                restaurant_pricerange_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                           clean_up_tokenization_spaces=True)
                                for y in range(len(restaurant_pricerange)):
                                    embeddings1 = model_sts.encode(restaurant_pricerange[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(restaurant_pricerange_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                    ...
                    if present_intent == "taxi": # if 1 == 1:
                        for i in range(len(listaTaxi)):
                            ...
                            correct = 0
                            if i == 0 and score > 0.95:
                                taxi_arriveby_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                   clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(taxi_arriveby, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(taxi_arriveby_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_taxi = 1
                            ...
                            if i == 1 and score > 0.95:
                                taxi_departure_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                    clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(taxi_departure, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(taxi_departure_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_taxi = 1
                                    cont_taxi_certo = cont_taxi_certo + 1
                            ...
                            if i == 1:
                                if taxi_departure != "" and taxi_departure_2 == "" and tx_departure == 1:
                                    ...
                                    cont_taxi_notfilled = cont_taxi_notfilled + 1
                            if i == 2 and score > 0.95:
                                taxi_destination_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                      clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(taxi_destination, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(taxi_destination_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_taxi = 1
                                    cont_taxi_certo = cont_taxi_certo + 1
                            ...
                            if i == 2:
                                if taxi_destination != "" and taxi_destination_2 == "" and tx_destination == 1:
                                    ...
                                    cont_taxi_notfilled = cont_taxi_notfilled + 1
                            if i == 3 and score > 0.95:
                                taxi_leaveat_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                  clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(taxi_leaveat, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(taxi_leaveat_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_taxi = 1
                                    cont_taxi_certo = cont_taxi_certo + 1
                    ...
                    if present_intent == "train": # if 1 == 1:
                        for i in range(len(listaTrain)):
                            ...
                            correct = 0
                            if i == 0 and score > 0.95:
                                train_arriveby_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                    clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(train_arriveby, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(train_arriveby_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_train = 1
                            ...
                            if i == 1 and score > 0.90:
                                train_bookpeople_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                      clean_up_tokenization_spaces=True)
                                for y in range(len(train_bookpeople)):
                                    embeddings1 = model_sts.encode(train_bookpeople[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(train_bookpeople_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 1:
                                if train_bookpeople != "" and train_bookpeople_2 == "" and tr_bookpeople == 1:
                                    verify_train = 0
                                    tr_bookpeople = 0
                                    cont_train_notfilled = cont_train_notfilled + 1
                            if i == 2 and score > 0.95:
                                train_day_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                               clean_up_tokenization_spaces=True)
                                for y in range(len(train_day)):
                                    embeddings1 = model_sts.encode(train_day[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(train_day_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 2:
                                if len(train_day) != 0 and train_day_2 == "" and tr_day == 1:
                                    ...
                                    cont_train_notfilled = cont_train_notfilled + 1
                            if i == 3 and score > 0.95:
                                train_departure_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                     clean_up_tokenization_spaces=True)
                                for y in range(len(train_departure)):
                                    embeddings1 = model_sts.encode(train_departure[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(train_departure_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 3:
                                if len(train_departure) != "" and train_departure_2 == "" and tr_departure == 1:
                                    verify_train = 0
                                    tr_departure = 0
                                    cont_train_notfilled = cont_train_notfilled + 1
                            if i == 4 and score > 0.95:
                                train_destination_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                       clean_up_tokenization_spaces=True)
                                for y in range(len(train_destination)):
                                    embeddings1 = model_sts.encode(train_destination[y], convert_to_tensor=True)
                                    embeddings2 = model_sts.encode(train_destination_2, convert_to_tensor=True)
                                    cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                    if cosine_scores[0][0] >= 0.49:
                                        correct = 1
                                if correct == 1:
                            ...
                            if i == 4:
                                if train_destination != "" and train_destination_2 == "" and tr_destination == 1:
                                    verify_train = 0
                                    tr_destination = 0
                                    cont_train_notfilled = cont_train_notfilled + 1
                            if i == 5 and score > 0.95:
                                train_leaveat_2 = tokenizer.decode(outputs[0][0], skip_special_tokens=True,
                                                                   clean_up_tokenization_spaces=True)
                                embeddings1 = model_sts.encode(train_leaveat, convert_to_tensor=True)
                                embeddings2 = model_sts.encode(train_leaveat_2, convert_to_tensor=True)
                                cosine_scores = util.cos_sim(embeddings1, embeddings2)
                                if cosine_scores[0][0] >= 0.49:
                                    verify_train = 1
                                    cont_train_certo = cont_train_certo + 1
...
with open(
        'C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/results_sts_0.49.csv',
        'a', encoding='UTF8', newline='') as f:
    with open(
            "C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/Ev_by_slots_STS/results_sts_0.49.txt",
            "w") as file:
        writer = csv.writer(f)
        ...
        jga = round(
            cont_turns_correct_attraction / (cont_turns_correct_attraction + cont_turns_incorrect_attraction),
            2)
        ...
        print("Score by slots: ",
              "\n", "Slot Area: ",
              cont_attraction_area_certo / (cont_attraction_area_certo + cont_attraction_area_errado),
              "\n", "Slot Name: ",
              cont_attraction_name_certo / (cont_attraction_name_certo + cont_attraction_name_errado),
              "\n", "Slot Type: ",
              cont_attraction_type_certo / (cont_attraction_type_certo + cont_attraction_type_errado))

        file.write("Slot Area:" + " " + str(
            cont_attraction_area_certo / (cont_attraction_area_certo + cont_attraction_area_errado)) + "\n")
        file.write("Slot Name:" + " " + str(
            cont_attraction_name_certo / (cont_attraction_name_certo + cont_attraction_name_errado)) + "\n")
        file.write("Slot Type:" + " " + str(
            cont_attraction_type_certo / (cont_attraction_type_certo + cont_attraction_type_errado)) + "\n")
        file.write("\n")
        # HOTEL
        print("\n")
        ...
        print("Score by slots: ",
              ...
              "\n", "Slot BookDay: ",
              cont_hotel_bookday_certo / (cont_hotel_bookday_certo + cont_hotel_bookday_errado),
              "\n", "Slot BookPeople: ",
              cont_hotel_bookpeople_certo / (cont_hotel_bookpeople_certo + cont_hotel_bookpeople_errado),
              "\n", "Slot BookStay: ",
              cont_hotel_bookstay_certo / (cont_hotel_bookstay_certo + cont_hotel_bookstay_errado),
              "\n", "Slot Internet: ",
              cont_hotel_internet_certo / (cont_hotel_internet_certo + cont_hotel_internet_errado),
              "\n", "Slot Name: ", cont_hotel_name_certo / (cont_hotel_name_certo + cont_hotel_name_errado),
              "\n", "Slot Parking: ",
              cont_hotel_parking_certo / (cont_hotel_parking_certo + cont_hotel_parking_errado),
              "\n", "Slot PriceRange: ",
              cont_hotel_pricerange_certo / (cont_hotel_pricerange_certo + cont_hotel_pricerange_errado),
        ...
        file.write("Slot Area:" + " " + str(
            cont_hotel_area_certo / (cont_hotel_area_certo + cont_hotel_area_errado)) + "\n")
        file.write("Slot BookDay:" + " " + str(
            cont_hotel_bookday_certo / (cont_hotel_bookday_certo + cont_hotel_bookday_errado)) + "\n")
        file.write("Slot BookPeople:" + " " + str(
            cont_hotel_bookpeople_certo / (cont_hotel_bookpeople_certo + cont_hotel_bookpeople_errado)) + "\n")
        file.write("Slot BookStay:" + " " + str(
            cont_hotel_bookstay_certo / (cont_hotel_bookstay_certo + cont_hotel_bookstay_errado)) + "\n")
        file.write("Slot Internet:" + " " + str(
            cont_hotel_internet_certo / (cont_hotel_internet_certo + cont_hotel_internet_errado)) + "\n")
        file.write("Slot Name:" + " " + str(
            cont_hotel_name_certo / (cont_hotel_name_certo + cont_hotel_name_errado)) + "\n")
        file.write("Slot Parking:" + " " + str(
            cont_hotel_parking_certo / (cont_hotel_parking_certo + cont_hotel_parking_errado)) + "\n")
        file.write("Slot PriceRange:" + " " + str(
            cont_hotel_pricerange_certo / (cont_hotel_pricerange_certo + cont_hotel_pricerange_errado)) + "\n")
        file.write("Slot Stars:" + " " + str(
            cont_hotel_stars_certo / (cont_hotel_stars_certo + cont_hotel_stars_errado)) + "\n")
        file.write("Slot Type:" + " " + str(
            cont_hotel_type_certo / (cont_hotel_type_certo + cont_hotel_type_errado)) + "\n")
        file.write("\n")
        # RESTAURANT
        print("\n")
        ...
        f1 = round(2 * ((precision * recall) / (precision + recall)), 2)
        jga = round(
            cont_turns_correct_restaurant / (cont_turns_correct_restaurant + cont_turns_incorrect_restaurant),
            2)
        data = ["-", jga, f1, precision, recall]
        writer.writerow(data)
        ...
        print("Score by slots: ",
              "\n", "Slot Area: ",
              cont_restaurant_area_certo / (cont_restaurant_area_certo + cont_restaurant_area_errado),
              "\n", "Slot BookDay: ",
              cont_restaurant_bookday_certo / (cont_restaurant_bookday_certo + cont_restaurant_bookday_errado),
              "\n", "Slot BookPeople: ",
              cont_restaurant_bookpeople_certo / (
                          cont_restaurant_bookpeople_certo + cont_restaurant_bookpeople_errado),
              "\n", "Slot BookTime: ",
              cont_restaurant_booktime_certo / (cont_restaurant_booktime_certo + cont_restaurant_booktime_errado),
              "\n", "Slot Food: ",
              cont_restaurant_food_certo / (cont_restaurant_food_certo + cont_restaurant_food_errado),
              "\n", "Slot Name: ",
              cont_restaurant_name_certo / (cont_restaurant_name_certo + cont_restaurant_name_errado),
              "\n", "Slot PriceRange: ",
              cont_restaurant_pricerange_certo / (
                          cont_restaurant_pricerange_certo + cont_restaurant_pricerange_errado))

        file.write("Slot Area:" + " " + str(
            cont_restaurant_area_certo / (cont_restaurant_area_certo + cont_restaurant_area_errado)) + "\n")
        file.write("Slot BookDay:" + " " + str(cont_restaurant_bookday_certo / (
                    cont_restaurant_bookday_certo + cont_restaurant_bookday_errado)) + "\n")
        file.write("Slot BookPeople:" + " " + str(cont_restaurant_bookpeople_certo / (
                    cont_restaurant_bookpeople_certo + cont_restaurant_bookpeople_errado)) + "\n")
        file.write("Slot BookTime:" + " " + str(cont_restaurant_booktime_certo / (
                    cont_restaurant_booktime_certo + cont_restaurant_booktime_errado)) + "\n")
        file.write("Slot Food:" + " " + str(
            cont_restaurant_food_certo / (cont_restaurant_food_certo + cont_restaurant_food_errado)) + "\n")
        file.write("Slot Name:" + " " + str(
            cont_restaurant_name_certo / (cont_restaurant_name_certo + cont_restaurant_name_errado)) + "\n")
        file.write("Slot PriceRange:" + " " + str(cont_restaurant_pricerange_certo / (
                    cont_restaurant_pricerange_certo + cont_restaurant_pricerange_errado)) + "\n")
        file.write("\n")
        # TAXI
        print("\n")
        ...
        print("Score by slots: ",
              "\n", "Slot ArriveBy: ",
              cont_taxi_arriveby_certo / (cont_taxi_arriveby_certo + cont_taxi_arriveby_errado),
              "\n", "Slot Departure: ",
              cont_taxi_departure_certo / (cont_taxi_departure_certo + cont_taxi_departure_errado),
              "\n", "Slot Destination: ",
              cont_taxi_destination_certo / (cont_taxi_destination_certo + cont_taxi_destination_errado),
              "\n", "Slot LeaveAt: ",
              cont_taxi_leaveat_certo / (cont_taxi_leaveat_certo + cont_taxi_leaveat_errado))

        file.write("Slot ArriveBy:" + " " + str(
            cont_taxi_arriveby_certo / (cont_taxi_arriveby_certo + cont_taxi_arriveby_errado)) + "\n")
        file.write("Slot Departure:" + " " + str(
            cont_taxi_departure_certo / (cont_taxi_departure_certo + cont_taxi_departure_errado)) + "\n")
        file.write("Slot Destination:" + " " + str(
            cont_taxi_destination_certo / (cont_taxi_destination_certo + cont_taxi_destination_errado)) + "\n")
        file.write("Slot LeaveAt:" + " " + str(
            cont_taxi_leaveat_certo / (cont_taxi_leaveat_certo + cont_taxi_leaveat_errado)) + "\n")
        file.write("\n")
        # TRAIN
        print("\n")
        ...
        print("Score by slots: ",
              "\n", "Slot ArriveBy: ",
              cont_train_arriveby_certo / (cont_train_arriveby_certo + cont_train_arriveby_errado),
              "\n", "Slot BookPeople: ",
              cont_train_bookpeople_certo / (cont_train_bookpeople_certo + cont_train_bookpeople_errado),
              "\n", "Slot Day: ", cont_train_day_certo / (cont_train_day_certo + cont_train_day_errado),
              "\n", "Slot Departure: ",
              cont_train_departure_certo / (cont_train_departure_certo + cont_train_departure_errado),
              "\n", "Slot Destination: ",
              cont_train_destination_certo / (cont_train_destination_certo + cont_train_destination_errado),
              "\n", "Slot LeaveAt: ",
              cont_train_leaveat_certo / (cont_train_leaveat_certo + cont_train_leaveat_errado))
        ...
        file.write("Slot BookPeople:" + " " + str(
            cont_train_bookpeople_certo / (cont_train_bookpeople_certo + cont_train_bookpeople_errado)) + "\n")
        file.write(
            "Slot Day:" + " " + str(cont_train_day_certo / (cont_train_day_certo + cont_train_day_errado)) + "\n")
        file.write("Slot Departure:" + " " + str(
            cont_train_departure_certo / (cont_train_departure_certo + cont_train_departure_errado)) + "\n")
        file.write("Slot Destination:" + " " + str(
            cont_train_destination_certo / (cont_train_destination_certo + cont_train_destination_errado)) + "\n")
        file.write("Slot LeaveAt:" + " " + str(
            cont_train_leaveat_certo / (cont_train_leaveat_certo + cont_train_leaveat_errado)) + "\n")
        print(
            cont_turns_correct_attraction + cont_turns_incorrect_attraction + cont_turns_correct_hotel + cont_turns_incorrect_hotel + cont_turns_correct_restaurant + cont_turns_incorrect_restaurant + cont_turns_correct_taxi + cont_turns_incorrect_taxi + cont_turns_correct_train + cont_turns_incorrect_train)
