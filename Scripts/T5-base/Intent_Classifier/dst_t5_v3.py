                                        ...
                                        if linha[0] == "\"train-leaveat\"":
                                            for line in f:
                                                ...
                                                if len(linha) == 2:
                                                    ...
                                                    train_leaveat = train_leaveat[1:]
                                                    train_leaveat = train_leaveat[:-1]
                                                # print("train_leaveat - ", train_leaveat)
                                                break
                    ...
                    if present_intent == "hotel": # if 1 == 1:
                        for i in range(len(listaHotel)):
                            ...
                            if i == 3 and score > 0.95:
                                ...
                                #    print(hotel_bookstay, " errado ", hotel_bookstay_2)
                            if i == 3:
                            ...
                            if i == 5 and score > 0.95:
                                ...
                                #    print(hotel_name, " ACERTOU ", hotel_name_2)
                                elif hotel_name == "":
                                    verify_hotel = 0
                                    cont_hotel_filledincorrect = cont_hotel_filledincorrect + 1
                                else:
...
with open('C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/results.csv',
    ...
    with open("C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/Ev_by_slots/results.txt", "w") as file:
        writer = csv.writer(f)
