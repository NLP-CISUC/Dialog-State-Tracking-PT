...
# Semantic Textual Similarity PT
                                    ...
                                    if linha[1] == " [":
                                        ...
                                        if linha[0] == "\"attraction-type\"":
                                            for line in f:
                                                ...
                                                attraction_type.append(get_slots_pt("attraction-type", "multiple sports"))
                                    ...
                                    if linha[1] == " [":
                                        ...
                                        if linha[0] == "\"restaurant-bookday\"":
                                            for line in f:
                                                ...
                                                restaurant_bookday.append(get_slots_pt("restaurant-bookday", "wednesday"))
                                                restaurant_bookday.append(get_slots_pt("restaurant-bookday", "thursday"))
                                                restaurant_bookday.append(get_slots_pt("restaurant-bookday", "friday"))
                                                restaurant_bookday.append(get_slots_pt("restaurant-bookday", "saturday"))
                                                restaurant_bookday.append(get_slots_pt("restaurant-bookday", "sunday"))
                                                restaurant_bookday.append(get_slots_pt("restaurant-bookday", "dontcare"))
                                                break
                                        ...
                                        if linha[0] == "\"restaurant-pricerange\"":
                                            for line in f:
                                                restaurant_pricerange.append(get_slots_pt("restaurant-pricerange", "expensive"))
                                                restaurant_pricerange.append(get_slots_pt("restaurant-pricerange", "cheap"))
                                                restaurant_pricerange.append(get_slots_pt("restaurant-pricerange", "moderate"))
                                                restaurant_pricerange.append(get_slots_pt("restaurant-pricerange", "dontcare"))
                                                break
            ...
            if turn_id == "turn_id" and int(number) % 2 == 0:
                for line in f:
                    ...
                    if linha[0] == "},":
                        break
                    utterance = linha[3]
                    # Filling of Slots by the QA Model above a certain value for the 5 Domains - Post-processing method STS
                    ...
                    if present_intent == "restaurant":  # if 1 == 1:
                        for i in range(len(listaRestaurant)):
                            ...
                            if i == 4 and score > 0.79:
                                restaurant_food_2 = result['answer']
...
with open('C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/results_sts_0.49.csv',
        'a', encoding='UTF8', newline='') as f:
    with open("C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/Ev_by_slots_STS/results_sts_0.49.txt",
            "w") as file:
        writer = csv.writer(f)
        ...
        jga = round(cont_turns_correct_attraction / (cont_turns_correct_attraction + cont_turns_incorrect_attraction),
                    2)
        ...
        f1 = round(2 * ((precision * recall) / (precision + recall)), 2)
        jga = round(cont_turns_correct_restaurant / (cont_turns_correct_restaurant + cont_turns_incorrect_restaurant),
                    2)
        data = ["-", jga, f1, precision, recall]
        writer.writerow(data)
        ...
        print("Score by slots: ",
              ...
              "\n", "Slot BookPeople: ",
              cont_restaurant_bookpeople_certo / (cont_restaurant_bookpeople_certo + cont_restaurant_bookpeople_errado),
              "\n", "Slot BookTime: ",
              ...
              "\n", "Slot PriceRange: ",
              cont_restaurant_pricerange_certo / (cont_restaurant_pricerange_certo + cont_restaurant_pricerange_errado))
