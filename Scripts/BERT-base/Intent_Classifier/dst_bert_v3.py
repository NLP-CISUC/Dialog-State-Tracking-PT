    ...
    for line in f:
        ...
        if len(linha) == 2:
            ...
            if active_intent == "active_intent" and active_intent2 != "NONE":
                controlo_intent = active_intent2
                    ...
                    if present_intent == "attraction":
                        for i in range(len(listaAttraction)):
                            ...
                            if i == 1 and score > 0.79:
                                ...
                                if attraction_name == attraction_name_2:
                                    verify_attraction = 1
                                    cont_attraction_certo = cont_attraction_certo + 1
                            ...
                            if i == 2 and score > 0.69:
                                ...
                                for y in range(len(attraction_type)):
                                    if attraction_type[y] == attraction_type_2:
                                        correct = 1
                                if correct == 1:
                                    verify_attraction = 1
                                    cont_attraction_certo = cont_attraction_certo + 1
                        ...
                        for i in range(len(listaHotel)):
                            ...
                            if i == 1 and score > 0.79:
                                ...
                                for y in range(len(hotel_bookday)):
                                    if hotel_bookday[y] == hotel_bookday_2:
                                        correct = 1
                                if correct == 1:
                                    verify_hotel = 1
                                    cont_hotel_certo = cont_hotel_certo + 1
                            ...
                            if i == 4 and score > 0.79:
                                ...
                                for y in range(len(hotel_internet)):
                                    if hotel_internet[y] == hotel_internet_2:
                                        correct = 1
                                if correct == 1:
                                    verify_hotel = 1
                                    cont_hotel_certo = cont_hotel_certo + 1
                            ...
                            if i == 6 and score > 0.79:
                                ...
                                for y in range(len(hotel_parking)):
                                    if hotel_parking[y] == hotel_parking_2:
                                        correct = 1
                                if correct == 1:
                                    verify_hotel = 1
                                    cont_hotel_certo = cont_hotel_certo + 1
                        ...
                        for i in range(len(listaRestaurant)):
                            ...
                            if i == 0 and score > 0.59:
                                ...
                                for y in range(len(restaurant_area)):
                                    if restaurant_area[y] == restaurant_area_2:
                                        correct = 1
                                if correct == 1:
                                    verify_restaurant = 1
                            ...
                            if i == 1 and score > 0.49:
                                ...
                                for y in range(len(restaurant_bookday)):
                                    if restaurant_bookday[y] == restaurant_bookday_2:
                                        correct = 1
                                if correct == 1:
                                    verify_restaurant = 1
                                    cont_restaurant_certo = cont_restaurant_certo + 1
                            ...
                            if i == 4 and score > 0.69:
                                ...
                                if restaurant_food == restaurant_food_2:
                                    verify_restaurant = 1
                                    cont_restaurant_certo = cont_restaurant_certo + 1
                            ...
                            if i == 5 and score > 0.79:
                                ...
                                if restaurant_name == restaurant_name_2:
                                    verify_restaurant = 1
                                    cont_restaurant_certo = cont_restaurant_certo + 1
                    ...
                    if present_intent == "taxi":  # if 1 == 1:
                        for i in range(len(listaTaxi)):
                            ...
                            if i == 1 and score > 0.79:
                                ...
                                if taxi_departure == taxi_departure_2:
                                    verify_taxi = 1
                                    cont_taxi_certo = cont_taxi_certo + 1
                            ...
                            if i == 2 and score > 0.79:
                                ...
                                if taxi_destination == taxi_destination_2:
                                    verify_taxi = 1
                                    cont_taxi_certo = cont_taxi_certo + 1
                        ...
                        for i in range(len(listaTrain)):
                            ...
                            if i == 3 and score > 0.79:
                                ...
                                for y in range(len(train_departure)):
                                    if train_departure[y] == train_departure_2:
                                        correct = 1
                                if correct == 1:
                                    verify_train = 1
                                    cont_train_certo = cont_train_certo + 1
                            ...
                            if i == 4 and score > 0.79:
                                ...
                                for y in range(len(train_destination)):
                                    if train_destination[y] == train_destination_2:
                                        correct = 1
                                if correct == 1:
                                    verify_train = 1
                                    cont_train_certo = cont_train_certo + 1
                            ...
                            if i == 5 and score > 0.79:
                                ...
                                if train_leaveat == train_leaveat_2:
                                    verify_train = 1
                                    cont_train_certo = cont_train_certo + 1
...
with open('C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/results.csv',
          'a', encoding='UTF8', newline='') as f:
    with open("C:/Users/Francisco Pais/Desktop/multiwozPortugues-main/Experiments_For_Article/Ev_by_slots/results.txt",
              "w") as file:
        writer = csv.writer(f)
        ...
        file.write(
            "Slot Area:" + " " + str(cont_hotel_area_certo / (cont_hotel_area_certo + cont_hotel_area_errado)) + "\n")
        ...
        file.write("Slot Internet:" + " " + str(
            cont_hotel_internet_certo / (cont_hotel_internet_certo + cont_hotel_internet_errado)) + "\n")
        file.write(
            "Slot Name:" + " " + str(cont_hotel_name_certo / (cont_hotel_name_certo + cont_hotel_name_errado)) + "\n")
        ...
        file.write(
            "Slot Type:" + " " + str(cont_hotel_type_certo / (cont_hotel_type_certo + cont_hotel_type_errado)) + "\n")
        file.write("\n")
        # RESTAURANT
        print("\n")
